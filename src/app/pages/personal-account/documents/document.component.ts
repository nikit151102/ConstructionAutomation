...
export class DocumentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.subscribe(params => {
      ...
      if (configType && ['comparativeStatement', 'materialSpecification', 'workSpecification', 'actHideWorksRequest', 'journalGeneral','ActHydraTesting' , "ActScreedChecking" , "ActRoofShedding" , "ActClearingHighways"].includes(configType)) {
